...
export function CollaboratorAvatars() {
  ...
  return (
    <div className="absolute top-2 scale-75 left-1/2 flex -space-x-2  overflow-hidden pointer-events-none z-50 group bg-accent min-w-[200px] px-3 py-1 rounded-full ">
